...
public final class DistanceFormatter {
     ...
     * @return distance string formatted according to the rules of the formatter.
     */
    public static String format(int distanceInMeters, boolean realTime, String units) {
     ...
     * @return distance string formatted according to the rules of the formatter.
     */
    public static String format(int distanceInMeters, boolean realTime, Locale locale, String units) {
